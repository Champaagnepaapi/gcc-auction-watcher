...
- the row is deferred and the durable SOLD watermark is not allowed to advance past the unresolved non-final row;
- already proven final SOLD rows in the same scan may still be ingested and retained in the pending backlog;
- when the same row later becomes explicit `SOLD`, it is ingested normally and the watermark may advance after the committed boundary is reached;

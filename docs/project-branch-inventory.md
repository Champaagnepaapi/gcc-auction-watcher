...
État pertinent re-vérifié le **1 septembre 2026** après #216/#217, #219 et #220.

> `main` runtime production est ancré à `6a33ac33faa324f0fc1c6124fbb49bd736382b75` (#220). Toujours re-vérifier le HEAD GitHub live avant une action.

## Autorités

```text
V4 production                     main
V4 runtime production             6a33ac33faa324f0fc1c6124fbb49bd736382b75
TCGdex resilience source          fix/v4-tcgdex-transport-resilience-20260901 / #216 MERGED
TCGdex merge mirror               merge/v4-tcgdex-transport-resilience-20260901 / #217 MERGED
...
Docs closeout current             docs/post-220-production-closeout-20260901
```
...
- `fix/v4-tcgdex-transport-resilience-20260901` — #216, validated runtime `53a7fd0a...`, capacité mergée via #217 au merge `03824158ac899cf142199c42d4525386a573bc15` ; provenance à conserver ;
- `merge/v4-tcgdex-transport-resilience-20260901` — #217, miroir non-draft du même head `812faf3314747004949945e650e76ec9389973de`, utilisé comme véhicule de merge à cause du problème de toggle draft ;

...
État pertinent re-vérifié le **4 septembre 2026** après le merge production #247.

> `main` est actuellement ancré à `a7666faf4b0ef2fab74295a45ebcf75d9832f284`. Toujours re-vérifier le HEAD GitHub live avant une action.

## Autorités

```text
V4 production                     main / a7666faf4b0ef2fab74295a45ebcf75d9832f284
PokeTrace aggregate guard         fix/v4-poketrace-aggregate-quality-20260903 / #247 MERGED
Auction pagination fix            fix/v4-auction-pagination-default-preservation-20260903 / #245 MERGED
Docs closeout #245 + #247         docs/post-245-auction-pagination-closeout-20260903 / ACTIVE DOCS ONLY / #246
...
Toute suppression exige audit + autorisation explicite. **Aucune branche n'est supprimée par le closeout #246.**

## Branches V4 / main récentes

- `fix/v4-poketrace-aggregate-quality-20260903` — #247, base `a39c693d...`, head validé `03ce93ae08eedf3301813f030b67f120b7abd4a4`, validation `33799908680` SUCCESS, merge production `a7666faf4b0ef2fab74295a45ebcf75d9832f284` ;
...
- `docs/post-245-auction-pagination-closeout-20260903` — #246, branche docs-only courante ; closeout canonique #245 étendu à #247 après avancement de `main`; aucun changement runtime ;

...
La valorisation utilise une médiane pondérée par récence, un filtre robuste MAD/IQR, une fourchette prudente et un seuil de décote adaptatif (plancher 30 %). Pour les cartes PSA suffisamment identifiées, PSA Auction Prices Realized agit comme source indépendante de validation avant le fallback eBay public. Prix fixes et enchères doivent rester sous le prix maximal conseillé; une enchère admissible peut recevoir une alerte unique dans les cinq dernières minutes.

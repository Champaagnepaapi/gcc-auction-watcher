...
from v4_ppt_shadow_provider import install_v4_ppt_shadow
...
if __name__ == "__main__":
    ...
    # Opt-in only. When enabled, PPT observes the final V4 candidate set and
    # records SOLD_AGGREGATED 30/90/180d valuation/kinetics in shadow state.
    # It returns production opportunities bit-for-bit unchanged and never notifies.
    install_v4_ppt_shadow()
